export const titleContainsDisqualifyingPatternExtended = (inputString?: string) => {
    const pattern =
        /ntermiete| befristet|ntervermietung|ntermiet|interim|nterzuvermiete|Möbliert|eilgewerbe| möbliert| möbiliert|Befristet|UNTERMIETE|ZWISCHENMIETE|furnished|Furnished|subletting|Subletting|Sublet|sublet|shared flat|wischenmiete|wischennutzung|wir suchen|WG Bewohner|WG ROOM|WG-ROOM|WG-Wohnung|WG Zimmer|WG-Zimmer|Kurzzeitmiete|kurzzeitig|kurzfristig|suchen|temporary|Finderlohn|hort term|Paar sucht Wohnung|taugliche Wohnung gesucht|auf Zeit|Wir suchen/;
    const datumPattern =
