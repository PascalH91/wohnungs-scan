...
import { friedrichsheimUrl } from "./providerUrls";

const { minRoomSize, minRoomNumber, maxColdRent, maxWarmRent } = config.apartment;

async function extractFRIEDRICHSHEIMOffers(page: Page): Promise<{ offers: Offer[]; isMultiPages: boolean }> {
...
export const getFRIEDRICHSHEIMOffers = createScraper({
