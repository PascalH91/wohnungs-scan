...
const { minRoomSize, minRoomNumber, maxColdRent, maxWarmRent, includeWbs } = config.apartment;
...
export const gewobagUrl = `https://www.gewobag.de/fuer-mietinteressentinnen/suche/wohnung/?gesamtmiete_von&gesamtmiete_bis=${maxWarmRent}&gesamtflaeche_von=${minRoomSize}&gesamtflaeche_bis&zimmer_von=${minRoomNumber}&zimmer_bis${includeWbs ? "" : "&keinwbs=1"}&sort-by`;
